...
import { Children, createElement, Fragment, HTMLAttributes, HtmlHTMLAttributes, isValidElement, PropsWithChildren } from "react"
...
export function TableRow(props: HtmlHTMLAttributes<HTMLTableRowElement>) {
    return (
        <tr
            className='divide-x divide-gray-300 dark:divide-white/25'
            {...props}
        />
    )
}
