          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="space-y-4 md:space-y-6">
              <p className="max-w-[600px] text-gray-500 dark:text-gray-400">
                With 8+ years in clinical genetics I have developed FDA-approved
                devices and next-generation sequencing tests. I specialize in
                using variant science for test development, FDA approval
                readiness, and variant classification. My approach combines
                genetics expertise with problem-solving and data science to
                deliver impactful solutions for patients.
              </p>
