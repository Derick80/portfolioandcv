  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between items-center">
        <h1 className="text-2xl font-semibold capitalize">{props.meaning}</h1>
      </div>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div>
              ...
              <p className="whitespace-pre-wrap">{props.sentence_jp}</p>
            </div>
          </TooltipTrigger>
          <TooltipContent>
            <p className="whitespace-pre-wrap">{props.sentence_en}</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      <div className="flex flex-row items-center space-x-2">
      ...
      <div className="flex flex-row items-center space-x-2">
        {props.relatedBy && (
          <>
            <span className="font-semibold">Related Kanji:</span>
